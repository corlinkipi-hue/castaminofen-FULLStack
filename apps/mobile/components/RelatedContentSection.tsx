...
function createStyles(colors: ThemeColors) {
  return {
    ...
    heading: { color: colors.textPrimary, fontSize: 16, fontWeight: '700' as const, textAlign: 'right' as const, marginBottom: spacing.sm },
...
export function RelatedContentSection({ contentId }: { contentId: string }) {
  ...
  return (
    <View style={styles.section}>
      <Text style={styles.heading}>محتوای مرتبط</Text>
